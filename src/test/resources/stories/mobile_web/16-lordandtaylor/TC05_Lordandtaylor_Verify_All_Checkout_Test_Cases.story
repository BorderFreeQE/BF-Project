...
And [8009-0007] sleep after last action for 3000 Milliseconds
And [1000-9400] Execute $('#jsCheckoutRemediationGuestCheckout').click(); javascript
And [8009-0007] sleep after last action for 20000 Milliseconds
