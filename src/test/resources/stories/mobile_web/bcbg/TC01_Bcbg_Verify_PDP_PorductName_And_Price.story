...
And [8012-399] Navigate to `bcbgDirectURL` page
And [8012-993] User scroll 700 to laod items
And [1111-1080] bcbgEmailDialog should be displayed, Within 120 seconds
And [1100-1300] User clicks on the bcbgEmailDialogClose
