...
And [1101-1181] the user saves mobil Eddtiebauern PDP Name text in global scope under name eddiebauerPdpName
And [8012-9783] verfiy that text `eddiebauerProductName` and text `eddiebauerPdpName` are equals
And [1101-1181] the user saves mobil Eddtiebauern PDP Price text in global scope under name eddiebauerPdpPrice
