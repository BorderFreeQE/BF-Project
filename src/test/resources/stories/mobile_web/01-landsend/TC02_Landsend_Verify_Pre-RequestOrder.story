...
And [1000-9200] User navigate to the previous page
And [8012-399] Navigate to `landsend Direct URL` page
...
And [8012-992] sleep time 3000
And [1101-1181] the user saves mobile Landsend PDP Name text in global scope under name landsend PDP Product Name
And [1101-1181] the user saves mobile Landsend PDP Price text in global scope under name landsend PDP Product Price
