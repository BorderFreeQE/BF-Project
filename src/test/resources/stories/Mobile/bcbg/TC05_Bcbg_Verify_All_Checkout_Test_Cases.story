...
Scenario: TC05_Bcbg_Verify_All_Checkout_Test_Cases
...
!-- And [8028-0001] sleep after last action for 15000 Milliseconds
And [1000-9400] Execute $('.shipping-buttons button').click(); javascript
...
And [1000-9400] Execute $('#dwfrm_billing button.checkout-submit').click(); javascript
And [1211-1080] bcbgErrores should be all displayed, Within 120 seconds
